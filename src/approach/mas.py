...
class Appr(Inc_Learning_Appr):
    ...
    def __init__(self, model, device, nepochs=100, lr=0.05, lr_min=1e-4, lr_factor=3, lr_patience=5, clipgrad=10000,
                 momentum=0, wd=0, fix_bn=False, eval_on_train=False, task_ce_only=False,
                 logger=None, exemplars_dataset=None, lamb=1, alpha=0.5, fi_num_samples=-1, use_early_stopping=False):

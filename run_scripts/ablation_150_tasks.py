...
def run_methods(base_arguments, parallel_processes, exp_name):
    ...
    for seed in ["303", "0", "1"]:
        ...
        for appr in ["finetuning", "ewc", "mas", "initial_horde"]:
            # setup base methods
            if appr in ["finetuning", "freezing"]:
                runs.append(cur_arguments + ["--approach", appr,
                                              "--network", "resnet18_cbam", "--task-ce-only",
                ...
                for fe_selection in ["confusion_matrix", "max_classes"]:
                    runs.append(cur_arguments + ["--approach", appr,
                                                  ...
                                                  "--exp-name", f"{exp_name}_sel_{fe_selection}",
...
def experiment_cifar100():
    ...
    run_methods(base_arguments_cil, parallel_processes, "ablation_efcir_longer_sequence")
